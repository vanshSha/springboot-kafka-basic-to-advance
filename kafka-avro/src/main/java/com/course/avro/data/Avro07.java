...
public class Avro07 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** mandatory map */
  private java.util.Map<java.lang.CharSequence,java.lang.CharSequence> bestHeroVotes;
  /** map of (array of int) */
  private java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> lotteryNumbers;
  /** optional map */
  private java.util.Map<java.lang.CharSequence,java.lang.CharSequence> favouriteFoods;
  /** map with default value */
  private java.util.Map<java.lang.CharSequence,java.lang.CharSequence> favouritePets;
   ...
   */
  public Avro07(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> bestHeroVotes, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> lotteryNumbers, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> favouriteFoods, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> favouritePets) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: bestHeroVotes = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)value$; break;
    case 1: lotteryNumbers = (java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>>)value$; break;
    case 2: favouriteFoods = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)value$; break;
    case 3: favouritePets = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> getBestHeroVotes() {
   ...
   */
  public void setBestHeroVotes(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> getLotteryNumbers() {
   ...
   * @param value the value to set.
   */
  public void setLotteryNumbers(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> value) {
   ...
   * @return optional map
   */
  public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> getFavouriteFoods() {
   ...
   * @param value the value to set.
   */
  public void setFavouriteFoods(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> getFavouritePets() {
   ...
   * @param value the value to set.
   */
  public void setFavouritePets(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro07>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro07.Builder setBestHeroVotes(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro07.Builder setLotteryNumbers(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro07.Builder setFavouriteFoods(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro07.Builder setFavouritePets(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public Avro07 build() {
      try {
        ...
        record.bestHeroVotes = fieldSetFlags()[0] ? this.bestHeroVotes : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) defaultValue(fields()[0]);
        record.lotteryNumbers = fieldSetFlags()[1] ? this.lotteryNumbers : (java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>>) defaultValue(fields()[1]);
        record.favouriteFoods = fieldSetFlags()[2] ? this.favouriteFoods : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) defaultValue(fields()[2]);
        record.favouritePets = fieldSetFlags()[3] ? this.favouritePets : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.util.Map.Entry<java.lang.CharSequence, java.lang.CharSequence> e0: this.bestHeroVotes.entrySet()) {
      actualSize0++;
      out.startItem();
    ...
    long actualSize1 = 0;
    for (java.util.Map.Entry<java.lang.CharSequence, java.util.List<java.lang.Integer>> e1: this.lotteryNumbers.entrySet()) {
      actualSize1++;
      out.startItem();
    ...
    if (this.favouriteFoods == null) {
      ...
      long actualSize3 = 0;
      for (java.util.Map.Entry<java.lang.CharSequence, java.lang.CharSequence> e3: this.favouriteFoods.entrySet()) {
        actualSize3++;
        out.startItem();
    ...
    long actualSize4 = 0;
    for (java.util.Map.Entry<java.lang.CharSequence, java.lang.CharSequence> e4: this.favouritePets.entrySet()) {
      actualSize4++;
      out.startItem();
      out.writeString(e4.getKey());
      java.lang.CharSequence v4 = e4.getValue();
      out.writeString(v4);
    }
    out.writeMapEnd();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.Map<java.lang.CharSequence,java.lang.CharSequence> m0 = this.bestHeroVotes; // Need fresh name due to limitation of macro system
      if (m0 == null) {
      ...
      java.util.Map<java.lang.CharSequence,java.util.List<java.lang.Integer>> m1 = this.lotteryNumbers; // Need fresh name due to limitation of macro system
      if (m1 == null) {
        m1 = new java.util.HashMap<java.lang.CharSequence,java.util.List<java.lang.Integer>>((int)(size1 * 4)/3 + 1);
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.Map<java.lang.CharSequence,java.lang.CharSequence> m3 = this.favouriteFoods; // Need fresh name due to limitation of macro system
        if (m3 == null) {
          m3 = new java.util.HashMap<java.lang.CharSequence,java.lang.CharSequence>((int)(size3 * 4)/3 + 1);
      ...
      java.util.Map<java.lang.CharSequence,java.lang.CharSequence> m4 = this.favouritePets; // Need fresh name due to limitation of macro system
      if (m4 == null) {
        m4 = new java.util.HashMap<java.lang.CharSequence,java.lang.CharSequence>((int)(size4 * 4)/3 + 1);
      ...
      for ( ; 0 < size4; size4 = in.mapNext()) {
        for ( ; size4 != 0; size4--) {
          ...
          java.lang.CharSequence v4 = null;
          v4 = in.readString(v4 instanceof Utf8 ? (Utf8)v4 : null);
          m4.put(k4, v4);
        }
      }
