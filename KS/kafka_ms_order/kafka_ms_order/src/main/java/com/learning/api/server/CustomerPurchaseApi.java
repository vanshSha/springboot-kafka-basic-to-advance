...
import com.learning.api.response.PurchaseResponse;
import com.learning.command.service.CustomerPurchaseService;
...
public class CustomerPurchaseApi {
    ...
    public ResponseEntity<PurchaseResponse> createPurchaseMobile(@RequestBody CustomerPurchaseMobileRequest request) {
        var purchaseNumber = service.createdPurchaseMobile(request);
